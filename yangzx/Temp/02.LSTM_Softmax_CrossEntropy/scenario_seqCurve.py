...
sys.path.append(rootPath+'/DLbase')

from DLbase.xview import *
from DLbase.fc import *
from DLbase.rnn import *
from DLbase.optimizers import *
from DLbase.activators import *
from DLbase.session import *
...
def main_rnn():
    ...
    fc1 = FCLayer(Params.MINI_BATCH_SIZE, Params.TIMESTEPS*Params.HIDDEN_SIZE, Params.PRED_STEPS, NoAct, AdamOptimizer, optmParamsFc1,True,Params.DTYPE_DEFAULT,Params.INIT_W)
    # 拼接网络层
    seqLayers = [rnn1,fc1]
